...
means_init, covars_init, X = utils.initialize_with_kmeans(log_return_sequences)
...
for t_ret, h_ret in zip(log_return_sequences, hmm_generated_log_returns):
...
results = {hmm_wrapper.n_components: {'kl_mean': np.mean(kl_scores),
